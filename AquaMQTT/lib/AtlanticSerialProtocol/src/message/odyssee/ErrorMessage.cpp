...
namespace aquamqtt::message::odyssee
{
    ...
    {
        // there are no empty messages in the odyssee protocol
        return false;
    }
    ...
    uint8_t ErrorMessage::getAttr(const ERROR_ATTR_U8 attr)
    {
        switch (attr)
        {
    ...
    bool ErrorMessage::hasAttr(const ERROR_ATTR_U8 attr) const
    {
        switch (attr)
        {
        case ERROR_ATTR_U8::ERROR_REQUEST_ID:
