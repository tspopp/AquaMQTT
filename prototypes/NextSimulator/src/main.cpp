...
uint8_t msg193_b[] = {
        0xC1, 0x23, 0x2C, 0x00, 0x26, 0x00, 0x16, 0x00,
        0x16, 0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
        0x00, 0x00, 0x00, 0x00, 0x45, 0x45, 0x28, 0x00,
        0x00, 0x0E, 0x01, 0x11, 0x09,
};
...
uint8_t msg67_b[] = {
        0x43,0x2D,0x02,0x00,0x67,0x1D,0x00,0x00,
        0x00,0x00,0x02,0x00,0x00,0x00,0x67,0x1D,
        0x00,0x00,0x9D,0x74,0x3A,0x00,0x00,0x00,
        0x00,0x00,0x00,0x00,0x00,0x00,0x0B,0x4C,
        0x10,0x5A,0xFB,0x27,0xFB,0x25,0x0B,0x1B,
...
void loop() {
    if (next194 == 0) {
        ...
        Serial.write(msg194d, msg194_len);
        next194 = 0;
    }
    ...
    if(next_67 == 0){
        next_67 = 1;
        Serial.write(msg67_a, msg67_len);
    }else{
        next_67 = 0;
        Serial.write(msg67_b, msg67_len);
    }
    ...
    if (next193 == 0) {
        next193 = 1;
        Serial.write(msg193_a, msg193_len);
    } else {
        next193 = 0;
        Serial.write(msg193_b, msg193_len);
    }
